    ...
    <main className="font-mono flex min-h-screen flex-col items-center">
      <div className="w-full my-auto flex flex-row gap-12 px-36">
        <div className="w-1/2 flex flex-col items-start justify-center gap-8">
          ...
          <p className="text-lg">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eaque dicta iusto error explicabo tempora voluptatibus quis ut velit blanditiis. Tenetur expedita minus id voluptatum itaque? Ratione porro eaque odio sapiente quasi autem obcaecati asperiores molestiae neque.</p>
          <Link href="/start" className="bg-[#393E46] px-12 py-4 text-lg text-white">Get Started</Link>
        </div>
        <div className="w-1/2">
